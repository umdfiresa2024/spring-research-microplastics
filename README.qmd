...
# Nitrogen data
dc_n <- read.csv("US_WQ_Data/DC_nitro.csv")
de_n <- read.csv("US_WQ_Data/DE_nitro.csv")
md_n <- read.csv("US_WQ_Data/MD_nitro.csv")
ny_n <- read.csv("US_WQ_Data/NY_nitro.csv")
pa_n <- read.csv("US_WQ_Data/PA_nitro.csv")
va_n <- read.csv("US_WQ_Data/VA_nitro.csv")
wv_n <- read.csv("US_WQ_Data/WV_nitro.csv")
...
# Our final Carbon dataframe: df_final3
